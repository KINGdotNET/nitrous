...
const PLOGGING = {
    ...
    INTERLEAVE_PROMOTED: true,
    PROMOTED_POST_ACCOUNT: 'null',
    VESTING_TOKEN: 'BLURT POWER',
    SITE_DESCRIPTION:
        'Ploggin is a social media platform where everyone gets paid for ' +
        'creating and curating content. It leverages a robust digital points system, called PESOS, that ' +
        'supports real value for digital rewards through market price discovery and liquidity',
    // Revive Ads
    NO_ADS_STAKE_THRESHOLD: 9999999999,
    ...
    // Footer to attach to posts. ${POST_URL} is a macro that can be used, will be expanded to the URL of the post.
    POST_FOOTER:
        '\n\n---\n\n<center><sub>Posted via [Plogging.com](${POST_URL}) blog to earn BLURT and HIVE tokens.</sub></center>',
    COMMENT_FOOTER:
        '\n\n---\n\n<center><sub>Posted via [Plogging.com](${POST_URL}) blog to earn BLURT and HIVE tokens.</sub></center>',
    SCOT_TAG_FIRST: false,
    PINNED_POSTS_URL: null,
